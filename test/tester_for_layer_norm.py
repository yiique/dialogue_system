...
class TestModel(graph_base.GraphBase):
    ...
    def __init__(self, hyper_params=None, params=None):
        ...
        self.encoder = encoder.Encoder(
            ...
            self.hyper_params["encoder_h_dim"], norm=True)
        ...
        self.hred = HRED.HRED(self.hyper_params["encoder_h_dim"],
                              self.hyper_params["hred_h_dim"], self.hyper_params["emb_dim"], norm=True)
        self.decoder = decoder.Decoder(
            ...
            d_type="MASK", norm=True, hyper_params=None, params=None)
