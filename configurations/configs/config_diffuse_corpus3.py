...
tf.flags.DEFINE_integer("entities", 5470, """""")
...
tf.flags.DEFINE_float("loss_alpha", 0.1, """""")
tf.flags.DEFINE_float("loss_beta", 0.1, """""")
tf.flags.DEFINE_float("loss_gamma", 0.7, """""")
tf.flags.DEFINE_float("loss_decoder", 0.1, """""")
tf.flags.DEFINE_float("grad_clip", 5.0, """""")
tf.flags.DEFINE_float("learning_rate", 0.001, """""")
tf.flags.DEFINE_float("penalty_factor", 0.6, """""")
tf.flags.DEFINE_boolean("norm", False, """""")
tf.flags.DEFINE_integer("epoch", 61, """""")
