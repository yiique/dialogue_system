...
tf.flags.DEFINE_integer("enquire_can_num", 200, """""")
tf.flags.DEFINE_integer("diffuse_can_num", 100, """""")
tf.flags.DEFINE_integer("candidate_num", FLAGS.enquire_can_num + FLAGS.diffuse_can_num, """""")
tf.flags.DEFINE_integer("common_vocab", 8000, """""")
tf.flags.DEFINE_integer("entities", 10000, """""")
...
tf.flags.DEFINE_float("loss_alpha", 0.3, """""")
tf.flags.DEFINE_float("loss_beta", 0.2, """""")
tf.flags.DEFINE_float("loss_gamma", 0.2, """""")
tf.flags.DEFINE_float("loss_decoder", 1.0 - FLAGS.loss_alpha - FLAGS.loss_beta - FLAGS.loss_gamma, """""")
